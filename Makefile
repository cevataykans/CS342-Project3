...
libsmemlib.a:  smemlib.c
	gcc -Wall -c smemlib.c -lrt
	ar -cvq libsmemlib.a smemlib.o
	ranlib libsmemlib.a

app: app.c
	gcc -Wall -o app app.c -L. -lsmemlib -lrt

create_memory: create_memory.c
	gcc -Wall -o create_memory create_memory.c -L. -lsmemlib -lrt

destroy_memory: destroy_memory.c
	gcc -Wall -o destroy_memory destroy_memory.c -L. -lsmemlib -lrt
